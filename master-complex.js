...
const simple = require('./fixtures/master-complex.json')
var expect = chai.expect;

// "desafio": "Imprimir de acordo com o valor quais carros cada usuário pode comprar ex: Eu sou Wood tenho 400000
//  e posso comprar um Dynamics Pink MAS, se ele for VIP Informe quais carro ele também tem direito. Fazer isso para
//   Todos. Validar os endereços da Loja e o ceo.

async function mastercomplexGet(){
    try {
        ...
        for (let user of get.data.users) {
          ...
          if (affordableCars.length > 0) {
            ...
            const vipCars = get.data.products[5].VIPs.map(vip => vip.car);
